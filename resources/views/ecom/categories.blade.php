...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-2"></div>
        <div class="col-md-2" >
            <div class="panel-group" id="panel-778270">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a class="panel-title" data-toggle="collapse" data-parent="#panel-778270" href="#panel-element-134387">Men</a>
                    </div>
                    <div id="panel-element-134387" class="panel-collapse collapse ">
                        <div class="panel-body">
                           @foreach($sub_cat as $sub_cats)
                                <div class="panel-group" id="panel-778270">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <a class="panel-title" data-toggle="collapse" data-parent="#panel-134387" href="#panel-element-{{$sub_cats->id}}">{{$sub_cats->name}}</a>
                                        </div>
                                        <div id="panel-element-{{$sub_cats->id}}" class="panel-collapse collapse ">
                                            <div class="panel-body">
                                                @foreach($subs as $sub)
                                                    <div class="col-md-12" id="{{$sub->id}}">
                                                        @if($sub->cat_id==$sub_cats->id)
                                                            <div class="list-group">

                                                                    <div>
                                                                        <li style="cursor: pointer; cursor: hand; " id="filter"  class="list-group-item" onclick="filter('y{{$sub->id}}')">{{$sub->name}}</li>
                                                                    </div>
